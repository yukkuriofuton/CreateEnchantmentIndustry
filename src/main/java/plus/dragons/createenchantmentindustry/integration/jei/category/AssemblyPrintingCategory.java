...
import plus.dragons.createenchantmentindustry.integration.jei.animation.AnimatedPrinter;
...
public class AssemblyPrintingCategory extends SequencedAssemblySubCategory {
    ...
    public void draw(SequencedRecipe<?> recipe, GuiGraphics graphics, double mouseX, double mouseY, int index) {
        ...
        printer.withFluids(recipe.getRecipe().getFluidIngredients().getFirst().getMatchingFluidStacks())
