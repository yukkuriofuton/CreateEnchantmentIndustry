...
package plus.dragons.createenchantmentindustry.integration.jei.animation;
...
public class AnimatedPrinter extends AnimatedKinetics {
    ...
    public AnimatedPrinter withFluids(List<FluidStack> fluids) {
        this.fluids = fluids;
        return this;
    }
    ...
    public void draw(GuiGraphics graphics, int xOffset, int yOffset) {
        ...
        FluidRenderer.renderFluidBox(fluidStack.getFluid(), fluidStack.getAmount(), from, from, from, to, to, to, graphics.bufferSource(), poseStack, LightTexture.FULL_BRIGHT, false, true, fluidStack.getComponentsPatch());
        poseStack.popPose();
